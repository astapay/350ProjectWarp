...
{
    // Store variables to pass to a hurtbox
    private int damage;
    private int hitstun;
    ...
    // <param name="facingRight"> true if the user of the attack was facing right </param>
    // <param name="d"> the given damage of the hitbox </param>
    // <param name="h"> the given hitstun of the hitbox </param>
    // <param name="k"> the given knockback of the hitbox </param>
    ...
    // <summary>
    // Returns the hitstun of this hitbox
    // </summary>
    ...
    // <summary>
    // Returns the knockback of this hitbox
    // </summary>
